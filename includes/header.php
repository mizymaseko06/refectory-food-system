            ...
            ?>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="main-nav">
                    <ul class="navbar-nav d-flex align-items-center">
                        <li style="color: yellow;" class="me-5"><?php echo $_SESSION['email']?></li>
                        <li class="nav-item btn btn-primary me-3" style="border-radius: 50%;" data-bs-toggle="modal" data-bs-target="#cartModal"><i class="bi bi-cart"></i></li>
                        <li class="nav-item me-5" style="color: white"><i class="bi bi-wallet2 me-1"></i><span> <?php echo $_SESSION['balance']; ?> </span></li>
